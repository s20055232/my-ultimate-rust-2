...
//! "winter squash", and is commonly used for cultivars of Cucurbita argyrosperma,
...
//! C. pepo pumpkins are one of the oldest domesticated plants,
//! having been used as early as 7,000 to 5,500 BC. Today,
//! pumpkins of varied species are widely grown for food,
//! as well as for aesthetic and recreational purposes.
//! The pumpkin's thick shell contains edible seeds and pulp.
//! Pumpkin pie, for instance, is a traditional part of Thanksgiving meals in
//! Canada and the United States, and pumpkins are frequently carved as jack-o'-lanterns for
//! decoration around Halloween, although commercially canned pumpkin purée and pumpkin pie
//! fillings are usually made of different pumpkin varieties from
//! those used for jack-o'-lanterns.
//!
...
impl Pumpkin {
    /// If you smash the pumpkin, it wull be gone. Then it can't be used for pie.
    pub fn smash(self) {}
}
